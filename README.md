...
The Git revision history of `mpu6050` has been removed in order to integrate it code with this repository.  Its revision history can be found on Its README and LICENSE (MIT Software License) remain, and credit has been given below in *Thanks* as well as in `/LICENSE`.
